...
class ListFrame extends JFrame {
    ...
    ListFrame () {
        ...
        Button botaoret = new Button(1,new Rect(40,60,25,25, Color.green,Color.black));
        buts.add(botaoret);
        Button botaoel = new Button(2,new Ellipse(40,110,25,25, Color.green,Color.black));
        buts.add(botaoel);
        Button botaotri = new Button(3,new Triang(40,160,25,25, Color.green,Color.black));
        buts.add(botaotri);
        Button botaotra = new Button(4,new Trapezio(40,216,25,25, Color.green,Color.black));
        buts.add(botaotra);
